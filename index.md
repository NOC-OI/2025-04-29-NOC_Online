...
humandate: "April 29, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate: 2025-04-29        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
...
eventbrite: 1237787017289          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
...
<strong>Some adblockers block the registration window. If you do not see the
  registration box below, please go directly to the <a href="https://2025-04-29-web-apis.eventbrite.com">registration page.</a></strong>
